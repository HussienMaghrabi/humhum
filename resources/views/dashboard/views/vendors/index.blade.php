                    ...
                    @else
                        <table class="table table-hover">
                            ...
                            @foreach($data as $item)
                                ...
                                @include('dashboard.components.textModal', ['id' => $item->id.'a', 'text' => $item['address_'.App::getLocale()]])
                                @include('dashboard.components.textModal', ['id' => $item->id.'p', 'text' => $item->phone])
                            @endforeach
                        </table>
                @endif
                {!! Form::close()!!}
