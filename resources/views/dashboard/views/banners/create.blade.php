@php
    $headers = [
            __('dashboard.'.$resource['header']) => route($resource['route'].'.index', [App::getLocale()]),
            __('dashboard.Create') => '#'
        ];
@endphp
...
@section('content')
    ...
    <div class="content">
        <div class="box box-info">
            ...
            {{ Form::open(array('route'=>[$resource['route']. '.store','lang'=>App::getLocale()], 'method' => 'post','files'=>true, 'class' => 'form-horizontal')) }}
            <div class="box-body">
