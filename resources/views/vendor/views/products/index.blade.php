                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $item)
                            ...
                            <tr class="tr-{{ $item->id }}">
                                ...
                                <td>
                                    @php $category =  $item->sub_sub_category['name_'.App::getLocale()] @endphp
                                    @if($category)
                                        {{$category ." / ". $item->sub_category['name_'.App::getLocale()] }}
                                    @else
                                        {{$item->sub_category['name_'.App::getLocale()]}}
                                    @endif
                                ...
                                <td>
                                    @if($images > 0)
                                        <a href="{{ route('vendor.productImages.index', [App::getLocale(), $item->id]) }}">{{ $images }}</a></td>
                                @else
                                    {{ $images }}
                                @endif
                                <td>
