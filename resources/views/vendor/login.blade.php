...
<head>
    ...
    <title>{{ __('vendor.Hum Hum | Log in') }}</title>
...
<div class="login-box" style="margin-bottom:0; margin-top:0">
    ...
    <div><h4>{{__('dashboard.Designed by')}}<a href="https://valuxapps.com" target="_blank"> {{__('dashboard.Valux')}}</a></h4></div>
    <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
